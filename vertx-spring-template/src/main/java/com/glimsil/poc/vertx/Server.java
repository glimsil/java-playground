...
import com.glimsil.poc.vertx.config.ApiRegistry;
...
public class Server extends AbstractVerticle {
	...
	public void start() {
		...
		ApiRegistry.getInstance().get().forEach(endpoint -> {
			if() {

			}
			router.get(endpoint.getRoute()).handler(endpoint.getRequestHandler());
		});
